...
console.log(_reactNative.default.processColor('red'));
...
class PagerView extends _react.default.Component {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_PagerViewNative.PagerViewViewManager, _extends({}, this.props, {
      ...
      /** TODO: Fix ref type */
      ,
      style: this.props.style // pageIndicatorProps={
      //   this.props.pageIndicatorProps
      //     ? {
      //         activeDotColor: normalizeColorBase(
      //           this.props.pageIndicatorProps.activeDotColor
      //         ),
      //         inactiveDotColor: normalizeColorBase(
      //           this.props.pageIndicatorProps.inactiveDotColor
      //         ),
      //       }
      //     : undefined
      // }

...
export class PagerView extends React.PureComponent {
  ...
  componentDidMount() {
    if (this.props.initialPage != null && this.props.initialPage > 0) {
      ...
      UIManager.dispatchViewManagerCommand(findNodeHandle(this), 'setPage', [this.props.initialPage, false]);
    }
  }
  /**
  ...
  setPage(page, animated = true) {
    ...
    requestAnimationFrame(() => {
      UIManager.dispatchViewManagerCommand(findNodeHandle(this), 'setPage', [page, animated]);
    });
  }
  /**
   * A helper function to scroll to a specific page in the PagerView.
  ...
  setScrollEnabled(scrollEnabled) {
    UIManager.dispatchViewManagerCommand(findNodeHandle(this), 'setScrollEnabled', [scrollEnabled]);
  }
  /**
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(PagerViewNative, {
      childrenKeys: keys,
